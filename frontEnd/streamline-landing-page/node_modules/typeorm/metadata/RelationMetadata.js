...
var RelationMetadata = /** @class */ (function () {
    ...
    RelationMetadata.prototype.setEntityValue = function (entity, value) {
        ...
        if (this.embeddedMetadata) {
            ...
            return extractEmbeddedColumnValue_2((0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(this.embeddedMetadata.embeddedMetadataTree), false), entity);
        }
        else {
    ...
    RelationMetadata.prototype.registerForeignKeys = function () {
        ...
        (_a = this.foreignKeys).push.apply(_a, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(foreignKeys), false));
    };
    /**
